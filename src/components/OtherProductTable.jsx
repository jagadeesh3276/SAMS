...
const OtherProductTable = () => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [items, setItems] = useState([
    {
      category: "Classroom Equipment",
      productName: "Whiteboards",
      hsnCode: "12345",
      unit: "1",
      price: "200",
      cgst: "5",
  ...
  // handle edit input change (inline)
  ...
  const handleSaveEdit = (index) => {
    ...
    const total =
      ...
      (parseFloat(editData.price || 0) *
        (parseFloat(editData.cgst || 0) + parseFloat(editData.sgst || 0))) /
        100;
...
// handle input change for form
  ...
  // STOCK SECTION
    const [stock, setStock] = useState([
      { productName: "EBooks", totalStock: 10002, used: 20, date: "2025-01-10" },
      { productName: "White Boards", totalStock: 60, used: 15, date: "2025-01-15" },
    ]);
  ...
  return (
    <div className="mt-[90px] ml-[250px] p-5 w-[calc(100%-250px)]">
      <h2 className="text-center mb-5 font-bold text-xl">Other Product TABLE</h2>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
          <div className="bg-white w-[400px] rounded-xl shadow-2xl p-6">
            ...
            <div className="space-y-3">
              {["category", "productName", "hsnCode", "unit"].map((field) => (
                <input
                  key={field}
                  type="text"
                  name={field}
...
export default OtherProductTable;
