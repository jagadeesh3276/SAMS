...
// STOCK SECTION
  const [stock, setStock] = useState([
    { productName: "tie", totalStock: 100, used: 20, date: "2025-01-10" },
    { productName: "belt", totalStock: 60, used: 15, date: "2025-01-15" },
  ]);
...
const handlePrintInvoice = (row) => {
  ...
  return (
    <div className="mt-[90px] ml-[250px] p-5 w-[calc(100%-250px)]">
      <h2 className="text-center mb-5 font-bold text-xl">Uniform TABLE</h2>
