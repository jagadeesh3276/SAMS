      ...
      <section className="my-16 container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="bg-white shadow-xl p-6 rounded-2xl hover:-translate-y-2 transition-all">
            ...
            />
            <h5 className="font-bold text-lg text-center mb-2">Outdoor Games</h5>
            <p className="text-center text-gray-600">
              Cricket, Football, Basketball, Volleyball, Athletics, Track Events.
            </p>
          </div>
          ...
          <div className="bg-white shadow-xl p-6 rounded-2xl hover:-translate-y-2 transition-all">
            <img
              ...
              className="h-32 mx-auto mb-4"
            />
            <h5 className="font-bold text-lg text-center mb-2">Indoor Games</h5>
            <p className="text-center text-gray-600">
              Chess, Carrom, Table Tennis, Badminton.
            </p>
          </div>
          ...
          <div className="bg-white shadow-xl p-6 rounded-2xl hover:-translate-y-2 transition-all">
            <img
              ...
              className="h-32 mx-auto mb-4"
            />
            <h5 className="font-bold text-lg text-center mb-2">Fitness & Training</h5>
            <p className="text-center text-gray-600">
              Yoga, Gymnastics, and Physical Education drills.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="my-16 container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <ul className="list-disc pl-6 space-y-3 text-lg text-gray-700">
            <li>50+ medals won in district-level athletic and sports competitions.</li>
            <li>15 inter-school championship trophies (Cricket, Basketball, Badminton).</li>
            <li>100+ student participations in state-level tournaments.</li>
            <li>Recognized as a top school for sports excellence (2024).</li>
          </ul>
