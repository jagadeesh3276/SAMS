...
>
  ...
  <p className="mt-4 text-lg font-medium text-gray-700">
   Exploring Interests, Building Skills
      ...
      <section className="my-16 container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="bg-white shadow-xl p-6 rounded-2xl hover:-translate-y-2 transition-all">
            ...
            />
            <h5 className="font-bold text-lg text-center mb-2">Science Club

</h5>
            <p className="text-center text-gray-600">
             Experiments, innovation projects, and science fairs.
          ...
          <div className="bg-white shadow-xl p-6 rounded-2xl hover:-translate-y-2 transition-all">
            <img
              ...
              className="h-32 mx-auto mb-4"
            />
            <h5 className="font-bold text-lg text-center mb-2">Music & Dance Club

</h5>
            <p className="text-center text-gray-600">
            Singing, instrumental training, and dance performances.
          ...
          <div className="bg-white shadow-xl p-6 rounded-2xl hover:-translate-y-2 transition-all">
            <img
              ...
              className="h-32 mx-auto mb-4"
            />
            <h5 className="font-bold text-lg text-center mb-2">
Social Service Club

</h5>
            <p className="text-center text-gray-600">
             Community outreach, awareness drives, and volunteering.
      ...
      <section className="my-16 container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <ul className="list-disc pl-6 space-y-3 text-lg text-gray-700">
            <li>10+ inter-school awards in debate, quiz, and literary competitions.

</li>
            <li>5 robotics projects showcased at district-level exhibitions.

</li>
            <li>15 performances by Music & Dance Club at cultural fests.

</li>
            <li>Community service initiatives that involved 100+ student volunteers.
